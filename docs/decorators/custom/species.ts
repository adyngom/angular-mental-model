interface Animal {
  name?:
    ...
    | 'Euryalea'
    | 'Euryalea_cinerea'
    | 'Euryalea_cinerea_cinerea'
    | 'Euryalea_cinerea_cinerea_cinerea'
    | 'Euryalea_cinerea_cinerea_cinerea_cinerea'
    ...
    | 'Euryalea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea'
    | 'Euryalea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea'
    | 'Euryalea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea'
    | 'Euryalea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea_cinerea'
  family?:
    | 'Mammal'
    | 'Bird'
    | 'Reptile'
...
function Species(config: Animal) {
  ...
  return function (target: any) {
    console.log(
      `Here is the ${_config.name} species class definition: \n\n${target}`
    )
